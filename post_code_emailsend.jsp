...
String oo="This is Your post activation Code";
...
PreparedStatement ps1=con1.prepareStatement("update login set pcode=? where id='"+id+"'");
...
ps1.executeUpdate();
 ...
 response.sendRedirect("add_msg.jsp?success");	  
}
