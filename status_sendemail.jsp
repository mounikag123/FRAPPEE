...
String oo="Now Your Facebook Will be in Use";
...
String messageText ="<b>"+emailid+"</b><br>Activation Code:"+c+"<br>Status:"+oo+"";
...
PreparedStatement ps1=con1.prepareStatement("update login set scode=? where id='"+id+"'");
