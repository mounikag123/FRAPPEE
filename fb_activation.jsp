    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
				...
				<form action="code_check.jsp">
				
				<table width="904" height="292">
				<tr>
          <td align="center" colspan="2" height="40"><font color="#FFCC00" size="5"><strong>Facebook Activation Page</strong></font></td>
        </tr>
		<tr><td width="416"><img src="images/activation_icon.jpg" width="330" height="250"></td>
		<td width="476">
		
		<table width="458" height="101"><tr>
                <td height="55"><font color="#FFFFFF" size="4"><strong>Enter Your Activation 
                  code</strong></font></td>
