...
<%
String query="SELECT name,acount from login";
...
JFreeChart chart = ChartFactory .createBarChart3D("facebook_attack", "Users", "Times",dataset, PlotOrientation.VERTICAL, true, true, false);
                
try
{
ChartUtilities.saveChartAsJPEG(new File("D:/apache-tomcat-6.0.18/webapps/facebook/images/logotype2.jpg"), chart, 700, 300);
...
<script language="javascript" type="text/javascript" src="datetimepicker.js">
	...
	<tr><td><img src="images/logotype2.jpg" width="634" height="273"></td></tr>
	</table>
